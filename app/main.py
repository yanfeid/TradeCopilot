...
def review_trade(trade_id: int):
    ...
    try:
        result = analysis.run_trade_review(t, perf, news)
    except analysis.AnalysisError as e:
        raise HTTPException(400, str(e))
...
def macro_via_claude():
    ...
    try:
        events = analysis.fetch_macro_events()
    except analysis.AnalysisError as e:
        raise HTTPException(400, str(e))
...
def search_events_endpoint(s: SearchIn):
    ...
    try:
        events = analysis.search_events(s.query.strip())
    except analysis.AnalysisError as e:
        raise HTTPException(400, str(e))
...
def analyze(ticker: str):
    ...
    try:
        result = analysis.run_analysis(tk, snapshot, trades, events)
    except analysis.AnalysisError as e:
        raise HTTPException(400, str(e))
...
def earnings_analysis(ticker: str):
    ...
    try:
        result = analysis.run_earnings_analysis(tk, earnings, overview, news, financials)
    except analysis.AnalysisError as e:
        raise HTTPException(400, str(e))
